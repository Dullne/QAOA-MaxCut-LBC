...
def data():
    print(os.getcwd())
    X_train, y_train = mnist_reader.load_mnist('datasets/fashion-mnist', kind='train')
    X_test, y_test = mnist_reader.load_mnist('datasets/fashion-mnist', kind='t10k')
    ...
    print(X_test_69_2d.shape,y_test_69.shape)
